                            ...
                            <div className="d-flex justify-content-between">
                                <ul className="navbar-nav mb-2 mb-lg-0">
                                    ...
                                    <li className="nav-item dropdown dropdown-mega-xxl nav-electric-item">
                                     <Link className="text-muted position-relative d-inline-flex" href="/"> <span className={`nav-link text-white ${showw === 2 ? 'show' : ""}`} style={{ height: "50px" }} data-bs-toggle="dropdown" aria-expanded="false" onClick={() => handleMenuClick(2)}>
                                            Home
                                        </span>
                                          </Link>
                                    ...
                                    <li className="nav-item dropdown dropdown-mega-xxl nav-electric-item">
                                      <Link className="text-muted position-relative d-inline-flex" href="/shop-full-width-layout"> <span className={`nav-link position-relative text-white ${showw === 3 ? 'show' : ""}`} style={{ height: "50px" }}  data-bs-toggle="dropdown" aria-expanded="false" onClick={() => handleMenuClick(3)}>
                                            Shop
                                        </span></Link> 

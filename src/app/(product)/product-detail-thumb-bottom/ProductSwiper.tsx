                        ...
                        <Col md={6}>
                            <div>
                                <div>
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={pro15} alt="Pro15Img" className="img-fluid w-100" priority />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={pro16} alt="Pro16Img" className="img-fluid w-100" priority />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                ...
                                <div className="mt-3">
                                    ...
                                    >
                                        <SwiperSlide>
                                            <Image src={pro15} alt="Pro15Img" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <Image src={pro16} alt="Pro16Img" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <Image src={thumb5} alt="Thumb5Img" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <Image src={thumb6} alt="Thumb6Img" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                    </Swiper>
                                </div>
                            </div>

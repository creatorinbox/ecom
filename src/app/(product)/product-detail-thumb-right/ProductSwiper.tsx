                            ...
                            <Row className="g-2 g-lg-0">
                                            ...
                                            <div className="swiper-wrapper">
                                                <SwiperSlide>
                                                    <div className="position-relative topbar-product-card overflow-hidden h-100">
                                                        <Image src={thumbpro10} alt="Thumbpro10Img" className="img-fluid w-100" priority />
                                                        <span className="new-label bg-danger text-white rounded-circle"> -34% </span>
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image src={thumb2} alt="Thumb2Img" className="img-fluid w-100" priority />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image src={thumb3} alt="Thumb3Img" className="img-fluid w-100" priority />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image src={thumb9} alt="Thumb9Img" className="img-fluid w-100" priority />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image src={thumb5} alt="Thumb5Img" className="img-fluid w-100" priority />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image src={thumb6} alt="Thumb6Img" className="img-fluid w-100" priority />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image src={thumb7} alt="Thumb7Img" className="img-fluid w-100" priority />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image src={thumb8} alt="Thumb8Img" className="img-fluid w-100" priority />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image src={thumb9} alt="Thumb9Img" className="img-fluid w-100" priority />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image src={thumb10} alt="Thumb10Img" className="img-fluid w-100" priority />
                                                </SwiperSlide>
                                            </div>
                                ...
                                <Col xl={2} className="mt-xl-3 mt-2 ms-2">
                                    ...
                                    >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={thumbpro10} alt="Thumbpro10Img" className="object-fit-cover" priority />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={thumb2} alt="Thumb2Img" className="img-fluid w-100" priority />
                                            </SwiperSlide>
                                        ...
                                        <ul className="list-unstyled m-0 p-0 d-flex flex-wrap align-items-center gap-2">
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={pro1} alt="Pro1Img" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
                                            ...
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={pro2} alt="Pro2Img" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
                                            <li className="d-inline-block fs-4 text-muted">
                                                +
                                            ...
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={pro3} alt="Pro3Img" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
                                            <li className="d-inline-block fs-4 text-muted">
                                                +
                                            ...
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={pro4} alt="Pro4Img" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
                                        </ul>
                                    </Col>

                        ...
                        >
                            <div>
                                <div>
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={thumb1} alt="Thumb1Img" className="img-fluid w-100" priority />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                            ...
                                            <SwiperSlide>
                                                <Image src={thumb4} alt="Thumb4Img" className="img-fluid w-100" priority />
                                            </SwiperSlide>
                                ...
                                <div className="mt-3">
                                    ...
                                    >
                                        <SwiperSlide>
                                            <Image src={thumb1} alt="Thumb1Img" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <Image src={thumb2} alt="Thumb2Img" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <Image src={thumb3} alt="Thumb3Img" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <Image src={thumb4} alt="Thumb4Img" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                    </Swiper>
                                </div>
                            </div>
